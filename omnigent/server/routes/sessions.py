...
def create_sessions_router(
    ...
    async def claude_permission_request_hook(
        ...
        # Claude Code is the legacy/default caller for this shared callback.
        # Other native hooks must identify themselves with a closed set so an
        # arbitrary request cannot inject a misleading agent name in the UI.
        ...
        params = ElicitationRequestParams(
            mode="form",
            message=f"{agent_label} wants to call **{tool_name}**",
