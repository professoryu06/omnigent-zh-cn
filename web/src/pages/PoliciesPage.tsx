  ...
  return (
    ...
    >
      <DialogContent className="max-h-[80vh] overflow-y-auto sm:max-w-md">
        <DialogHeader>
          <DialogTitle>{t("policies.addDialogTitle")}</DialogTitle>
          <DialogDescription>{t("policies.addDialogDescription")}</DialogDescription>
        </DialogHeader>
                        ...
                        placeholder={
                          prop?.type === "array"
                            ? prop?.default !== undefined
                              ...
                              : t("policies.commaSeparatedValues")
                            : prop?.default !== undefined
                              ? String(prop.default)
                              : ""
                        }
  ...
  return (
    <PageScroll contentClassName="px-6">
      ...
      >
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t("policies.removeDialogTitle", { name: deleteCandidate?.name ?? "" })}</DialogTitle>
            <DialogDescription>
              {t("policies.removeDialogDescription")}
            </DialogDescription>
          </DialogHeader>
          {actionError !== null && (
            <div
