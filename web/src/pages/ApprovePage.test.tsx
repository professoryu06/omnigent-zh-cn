...
function renderChinesePage(sessionId = "sess_1", elicitationId = "eli_1") {
  setLocale("zh-CN");
  return render(
    <I18nProvider>
      <MemoryRouter initialEntries={[`/approve/${sessionId}/${elicitationId}`]}>
...
describe("ApprovePage states", () => {
  ...
  it("shows the loading state in Chinese", () => {
    renderChinesePage();
    expect(screen.getByText("正在加载审批请求…")).toBeInTheDocument();
  });
