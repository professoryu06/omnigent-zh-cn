...
export function CreateAgentDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <DialogHeader>
          <DialogTitle>{t("newSession.createCustomAgent")}</DialogTitle>
        </DialogHeader>
        ...
        <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-y-auto">
          ...
          <div className="flex flex-col gap-1.5">
            <label className="text-xs font-medium text-muted-foreground">
              {t("agent.harness")} <span className="text-destructive">*</span>
            </label>
          ...
          <div className="flex flex-col gap-1.5">
            <label
              ...
              className="text-xs font-medium text-muted-foreground"
            >
              {t("newSession.model")} <span className="text-destructive">*</span>
            </label>
            <Input
          ...
          <div className="flex flex-col gap-2">
            <div className="flex items-center justify-between">
              <span className="text-xs font-medium text-muted-foreground">{t("agent.mcpTools")}</span>
              <Button
                type="button"
                variant="ghost"
                size="sm"
      ...
      {entry.transport === "stdio" ? (
        <>
          <Input
            ...
            placeholder={t("agentInfo.commandPlaceholder")}
          />
          <Input
            data-testid="create-agent-mcp-args"
            value={entry.args}
            onChange={(e) => onChange({ args: e.target.value })}
            placeholder={t("agentInfo.argsPlaceholder")}
          />
          <Textarea
