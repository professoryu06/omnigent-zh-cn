...
export function AppShell() {
  ...
  const shareDisabledReason = !shareDisabled
    ...
    : isCurrentServerLocal()
      ? t("app.sharingUnavailableLocal")
      : t("app.sharingDisabledServer");
        ...
        AgentInfoButton popover, opened from the header's three-dot menu. */}
          {hasAgentInfo && (
            <Dialog open={agentInfoOpen} onOpenChange={setAgentInfoOpen}>
              <DialogContent>
                <DialogHeader>
                  <DialogTitle>{t("app.agent")}</DialogTitle>
                  <DialogDescription className="sr-only">
                    {t("app.agentDescription")}
                  </DialogDescription>
                </DialogHeader>
