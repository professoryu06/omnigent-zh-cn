...
describe("CommentsPanel zh-CN locale", () => {
  it("shows Chinese placeholder text when locale is zh-CN", () => {
    setLocale("zh-CN");
    renderGated({
      canEdit: true,
      comments: [],
      activeSelection: { start_index: 0, end_index: 5, anchor_content: "test" },
    });
