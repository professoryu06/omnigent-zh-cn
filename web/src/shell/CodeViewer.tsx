  ...
  if (fileQuery.isError) {
    return (
      <div className="p-8 text-destructive text-sm">
        {t("editor.loadError", { detail: fileQuery.error instanceof Error ? fileQuery.error.message : String(fileQuery.error) })}
      </div>
    );
  }
