  ...
  const actions = useMemo<ActionCommand[]>(
    () => [
      ...
      },
      {
        ...
        label: t("commandPalette.toggleConversationsSidebar"),
        icon: PanelLeftIcon,
      ...
      },
      {
        ...
        label: t("commandPalette.toggleWorkspaceSidebar"),
        icon: PanelRightIcon,
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <Command shouldFilter={false} vimBindings={false} label={t("commandPalette.title")}>
          <CommandInput
            value={query}
          ...
          <CommandList>
            <CommandEmpty>
              {isFetching && debouncedQuery ? t("commandPalette.searching") : t("commandPalette.noResults")}
            </CommandEmpty>
            {sessions.length > 0 && (
