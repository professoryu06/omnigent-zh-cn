...
describe("ExecutionLogsPanel open/close gating", () => {
  ...
  it("shows the panel heading in Chinese when locale is zh-CN", () => {
    setLocale("zh-CN");
    renderPanel({ open: true });
  ...
  it("shows the main entry label in Chinese when locale is zh-CN", () => {
    // WHY: the "main" label is translated through translate() in buildLogEntries,
    // so switching locale should show the Chinese string.
    setLocale("zh-CN");
    renderPanel({ open: true });
