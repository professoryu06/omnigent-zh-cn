        ...
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              type="button"
              variant="outline"
              aria-label={t("userMessageNav.previous")}
            >
              <ChevronUpIcon className="size-4" />
            </Button>
          </TooltipTrigger>
          <TooltipContent side="left">{t("userMessageNav.previousTooltip")}</TooltipContent>
        </Tooltip>
        <Tooltip>
          <TooltipTrigger asChild>
            <Button
              ...
              type="button"
              variant="outline"
              aria-label={t("userMessageNav.next")}
            >
              <ChevronDownIcon className="size-4" />
            </Button>
          </TooltipTrigger>
          <TooltipContent side="left">{t("userMessageNav.nextTooltip")}</TooltipContent>
        </Tooltip>
      </div>
    </TooltipProvider>
  );
