...
export const MessageBranchPrevious = ({ children, ...props }: MessageBranchPreviousProps) => {
  ...
  return (
    <Button
      aria-label={t("message.branchPrevious")}
...
export const MessageBranchNext = ({ children, ...props }: MessageBranchNextProps) => {
  ...
  return (
    <Button
      aria-label={t("message.branchNext")}
      disabled={totalBranches <= 1}
      onClick={goToNext}
      size="icon-sm"
      type="button"
...
function ChatCodeBlockWrapToggle({ wrap, onToggle }: { wrap: boolean; onToggle: () => void }) {
  ...
  return (
    <Button
      aria-label={t("message.toggleWordWrap")}
      aria-pressed={wrap}
      ...
      onClick={onToggle}
      size="icon-sm"
      title={wrap ? t("message.disableWordWrap") : t("message.enableWordWrap")}
      type="button"
      variant="ghost"
    >
