...
describe("zh-CN", () => {
  ...
  it("shows the 'Thinking...' label in Chinese while streaming", () => {
    setLocale("zh-CN");
    renderReasoning(true);
    expect(screen.getByText("思考中...")).toBeInTheDocument();
  });

  it("shows the 'Thought for...' label in Chinese when settled", () => {
    setLocale("zh-CN");
    renderReasoning(false);
    expect(screen.getByText("思考了几秒钟")).toBeInTheDocument();
  });
});
