    ...
    <div className="flex flex-col gap-2" data-testid="exit-plan-mode-review">
      ...
      {rejecting ? (
        <div className="flex flex-col gap-2 pt-1" data-testid="exit-plan-mode-feedback">
          <Textarea
            autoFocus
            placeholder={t("exitPlanMode.feedbackPlaceholder")}
            value={feedback}
        ...
        <div className="flex flex-wrap gap-2 pt-1">
          <Button size="sm" onClick={onAcceptAuto}>
            ...
            {t("exitPlanMode.yesAutoMode")}
          </Button>
          <Button size="sm" variant="outline" onClick={onAccept}>
            <CheckIcon className="mr-1 size-3.5" />
            {t("exitPlanMode.yesManualApprove")}
          </Button>
          <Button size="sm" variant="outline" onClick={() => setRejecting(true)}>
            <XIcon className="mr-1 size-3.5" />
            {t("exitPlanMode.rejectWithFeedback")}
          </Button>
        </div>
      )}
    </div>
