...
describe("zh-CN", () => {
  ...
  it("shows Chinese labels when locale is zh-CN (binary approve/reject)", () => {
    setLocale("zh-CN");
    render(
      <ApprovalCard
  ...
  it("shows the responded 'Approved' and 'Rejected' labels in Chinese", () => {
    setLocale("zh-CN");

    const { rerender } = render(
      <ApprovalCard
        elicitationId="elic_zh_done"
        message="测试消息"
        phase="tool_call"
        policyName="approve_shell_commands"
        contentPreview="rm -rf /tmp/cache"
    ...
    rerender(
      <ApprovalCard
        elicitationId="elic_zh_rejected"
        message="测试消息"
        phase="tool_call"
        policyName="approve_shell_commands"
        contentPreview="rm -rf /tmp/cache"
  ...
  it("shows the Chinese working-directory label for a pending Codex command", () => {
    setLocale("zh-CN");
    render(
      <ApprovalCard
        elicitationId="elic_zh_codex"
        message=""
        phase="tool_call"
        policyName="approve_shell_commands"
        contentPreview=""
