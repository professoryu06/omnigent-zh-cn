    ...
    >
      <div className="flex shrink-0 items-center gap-1 border-border border-b bg-card px-2 py-1.5">
        ...
        <button
          ...
          disabled={!viewActive}
          aria-label={t("browser.toggleDevTools")}
        ...
        <button
          ...
          aria-label={designMode ? t("browser.exitDesignMode") : t("browser.enterDesignMode")}
          title={
            designMode
              ? t("browser.designModeActiveHint")
              : t("browser.designModeHint")
          }
          className={cn(
